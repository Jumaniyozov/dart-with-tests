...
void main() {
  // #region surface
  /// Every library `package:ch38_expenses/expenses.dart` offers.
  ///
  ...
  // #region runnable
  /// Every program `dart run ch38_expenses:<name>` will start.
  ///
  ...
  group('bin is a contract too', () {
    test('and it offers exactly the three programs it says it does', () {
      const runnable = {'expenses.dart', 'holding.dart', 'serve.dart'};
