...
void main() {
  ...
  group('why the file holds a Day and not a DateTime', () {
    ...
    test(
      'and the same instant in UTC is a different string and a different day',
      () {
        ...
        expect(
          ...
          isNot(local.toIso8601String().substring(0, 10)),
          reason:
              'measured where this book is written; the point is that it can '
              'differ at all, not which way it went',
        );
