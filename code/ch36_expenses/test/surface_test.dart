...
void main() {
  // #region surface
  /// Every library `package:ch36_expenses/expenses.dart` offers.
  ///
  ...
  // #region runnable
  /// Every program `dart run ch36_expenses:<name>` will start.
  ///
  ...
  group('bin is a contract too', () {
    test('and it offers exactly the two programs it says it does', () {
      const runnable = {'expenses.dart', 'serve.dart'};
